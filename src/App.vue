<template>
  <div class="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100 
    ...
    <div class="flex-1 p-3 sm:p-8" style = "background: url(https://pic1.imgdb.cn/item/685e9dee58cb8da5c878dfcf.webp) top; background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
